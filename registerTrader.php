...
if(isset($_POST['sub']))
{
    // echo trim($_POST['number']);
            ...
            $ulocation = "dbimage/" . $image;

            $logo = $_FILES["logo"]["name"];
            $utype = $_FILES['logo']['type'];
            $utmpname = $_FILES['logo']['tmp_name'];
            //$usize = $_FILES['productimage']['size'];
            $ulocation = "dbimage/" . $logo;
            ...
            else
            {
                    ...
                    if(!$uppercase || !$lowercase || !$number || !$specialChars || strlen($password) < 8) {
                        ...
                        include('mail.php');
                            ...
                            if($count==0){
                                $sql ='INSERT INTO "USER" (USER_ROLE,FIRST_NAME,MIDDLE_NAME,LAST_NAME,ADDRESS,EMAIL,PHONE_NO,GENDER,AGE,PASSWORD,TRADER_CATEGORY,STATUS,IMAGE,TRADER_LOGO)
                                VALUES(:srole,:fname,:mname,:lname,:adds,:email,:phonenumber,:gender,:age,:pass,:shop,:status,:image,:logo)';
                                $stid = oci_parse($connection,$sql);
...
<body class="login">
    ...
    <form action="" class="form" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="fname"  required placeholder="first name" value="" >
        ...
        <input type="text" name="shop" placeholder="shop" value="">
        <p class="error password-error">
        <?php echo $shop_error; ?>
        </p>
        ...
        <input type="text" name="cpassword"  placeholder="conform password" value="">
        <p class="error password-error">
        <?php echo $password_nodata; ?>
        </p>
        ...
        <label>Profile</label>
            ...
            <label>LOGO</label>
            <input type="file" class='inputbox' name="logo" placeholder="UploadLogo"
                >
            <p class="error password-error">
                <?php echo $password_nodata; ?>
            </p>    
