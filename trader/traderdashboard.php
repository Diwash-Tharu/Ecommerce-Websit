...
<head>
  ...
  <head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
        ...
        <link rel="stylesheet" href="./Traderdashboarda.css"></link>
...
<body >
    ...
    <?php
          ...
          echo "<h3>Welcome </h3>";  echo $_SESSION['username']; "<h3>TO Trader dashboard </h3></br>";
          echo "</br>Catogeory Type". $cat_type;
        ?>
        <div class="row">
            <div class="col-sm-3">
                <div class="card">
